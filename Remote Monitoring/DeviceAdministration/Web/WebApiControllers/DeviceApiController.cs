...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Web.WebApiControllers
{
    ...
    public class DeviceApiController : WebApiControllerBase
    {
        ...
        [Route("contact")]
        [AllowAnonymous]
        public async Task<HttpResponseMessage> ContactAsync([FromBody] string messageData)
        {
            string[] messageD = messageData.Split(new string[] { "#" }, StringSplitOptions.None);
            ...
            return await GetServiceResponseAsync<dynamic>(async () =>
            {
                try
                {
                    ...
                    {
                        client.BaseAddress = new Uri("https://smoochwebhook.azurewebsites.net/");
                        client.DefaultRequestHeaders.Accept.Clear();
                        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                        await client.PostAsJsonAsync("webhook/SendMessage", MessageData);
                    }
